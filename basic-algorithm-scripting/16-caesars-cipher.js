...
const rot13 = str => {
  return str.split('').map(letter => {
    ...
    return letter.charCodeAt(0) > 64 && letter.charCodeAt(0) < 91 ? String.fromCharCode((letter.charCodeAt(0) - 13) < 65 ? 91 - (65 - (letter.charCodeAt(0) - 13)) : letter.charCodeAt(0) - 13) : letter
  }).join('')
}
